...
app.post('/getProdutos/', async (req,res)=>{
    const produtoEncontrado = await modelodeUsuario.findOne({nomedoProduto: req.body.nomedoProduto, valordoProduto: req.body.valordoProduto})
...
app.post('/admin',async (req,res) =>{
    ...
    const produtoCriado = await modelodeUsuario.create({nomedoProduto: req.body.nomedoProduto, valordoProduto: req.body.valordoProduto})
